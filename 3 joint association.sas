...
DATAFILE= "\\Mac\Home\Desktop\Capstone Project\data\clinical biomarkers\joint\V2.xlsx"
DBMS=xlsx REPLACE;
GETNAMES=YES;
options nodate;
RUN;
...
DATAFILE= "\\Mac\Home\Desktop\Capstone Project\data\clinical biomarkers\joint\V4.xlsx"
DBMS=xlsx REPLACE;
GETNAMES=YES;
options nodate;
RUN;
...
model &y=&x GA_wk PA_Tot_V4 momagegroup momrace familyhis_dm prepregbmi GDM_treatment/covb INFLUENCE;
weight wtPA34;
repeated subject = PairID/ type = unstr;
quit;
data metabolite&obs;
...
PROC IMPORT OUT= clinical_biomarker_v2_imputed
DATAFILE= "\\Mac\Home\Desktop\Capstone Project\data\clinical biomarkers\control\V2_joint.xlsx"
DBMS=xlsx REPLACE;
GETNAMES=YES;
options nodate;
RUN;
...
PROC IMPORT OUT= clinical_biomarker_v4_imputed
DATAFILE= "\\Mac\Home\Desktop\Capstone Project\data\clinical biomarkers\control\V4_joint.xlsx"
DBMS=xlsx REPLACE;
GETNAMES=YES;
options nodate;
RUN;
...
proc genmod DATA=v4_transformed;
ods output GEEEmpPEst=metabolite&obs;
class &x PREGSLEP_fm013_v4 PairID momrace familyhis_dm prepregbmi education childsex/param=reference ref=first;
